    ...
    <footer className="bg-green text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/80">
              ...
              <p>
                ...
                <a href="mailto:contact@sppmt.org" className="hover:text-gold transition-colors">
                  contact@sppmt.org
                </a>
              </p>
              <p>
          ...
          {/* Get involved */}
          <div>
            <h3 className="font-semibold mb-4 text-gold">Get Involved</h3>
            <div className="space-y-3">
              <Link
                href="/donate"
                className="block w-full text-center bg-orange hover:bg-orange-dark text-white text-sm font-medium px-4 py-2.5 rounded-md transition-colors"
              >
                Donate
              </Link>
              <Link
                href="/join"
                className="block w-full text-center border border-white/40 hover:bg-white/10 text-white text-sm font-medium px-4 py-2.5 rounded-md transition-colors"
              >
                Volunteer
              </Link>
            </div>
